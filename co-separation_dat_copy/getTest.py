...
# arr = os.listdir('/ext_data2/manhnh/Results/result_only_pose_03072023/solo_solo')
# list_not_eval = []
# for f in os.listdir(arr):
#     f_path = os.path.join(arr, f)
#     for file in os.listdir(f_path):
#         if 'eval' not in file:
#             list_not_eval.append(f)
...
#     print(dir)
#     list_file.append("/ext_data2/manhnh/Results/result_only_pose_22062023/solo_solo/" + dir)
#     # sub = os.listdir("./results/mixed/" + dir)
#     cmd = ["python", "evaluateSeparation.py", "--results_dir","/ext_data2/manhnh/Results/result_only_pose_22062023/solo_solo/" + dir]
#     subprocess.run(cmd)

# for f in list_not_eval:
#     print(f)
#     cmd = ["python", "evaluateSeparation.py", "--results_dir","/ext_data2/manhnh/Results/result_only_pose_22062023/solo_solo/" + f]
#     subprocess.run(cmd)
# sdr = []
# sdr_mixed = []
# sdr_sdr_mixed  = []
...
for dir in arr:
    # list_file.append(dir)
    print(dir)
    list_file.append("/ext_data2/manhnh/Results/result_only_pose_03072023/solo_solo/" + dir)
    # sub = os.listdir("./results/mixed/" + dir)
    cmd = ["python", "evaluateSeparation.py", 
           "--results_dir","/ext_data2/manhnh/Results/result_only_pose_03072023/solo_solo/" + dir]
    subprocess.run(cmd)